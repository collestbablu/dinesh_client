                ...
                <div class="col-md-9 pad-lr-5 content" id="content">
                    ...
                    ?>
                        ...
                        <article class="post-wrap post-single box_shadow mar-lr-0 mar-t-10">
                            ...
                            $actual_link = "https://$_SERVER[HTTP_HOST]"."/".$this->uri->segment(1)."/".$this->uri->segment(2)."/".$this->uri->segment(3)."/";

                            ?>
                                <a target="_blank" href="https://api.whatsapp.com/send?text=<?=urlencode($actual_link)?>" data-action="share/whatsapp/share"><span class="social-icon"><i class="fa fa-whatsapp"></i></span></a>
                            </div>
                        </article>
                        <!-- /Blog post -->
