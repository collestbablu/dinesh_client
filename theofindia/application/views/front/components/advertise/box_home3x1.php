...
<div class="img-bg img-responsive image_delay1" style="height:95px;background-image: url(<?php echo base_url(); ?>uploads/default_banner/<?php echo $row['img']; ?>);"  alt="advertise"  ></div>
