        ...
        <div class="panel-body">
            ...
            <div class="form-group btm_border btm_border">
             ...
             <div class="form-group btm_border abstract">
                <label class="col-sm-4 control-label"><?php echo translate('Password'); ?></label>
                <div class="col-sm-6">
                    <input type="password" id="password"  class="form-control required" name="password"placeholder="<?php echo translate('password'); ?>">
                </div>
            </div> 
            <div class="form-group btm_border abstract">
