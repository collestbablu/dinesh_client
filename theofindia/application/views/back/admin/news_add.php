...
?>
                        <input type="text" class="form-control" name="date" value="<?=$dateTime->format("m/d/y  H:i A"); ?>" readonly />
            ...
            <div class="form-group btm_border">
                ...
                <div class="col-sm-10">
                    ...
                    <?php
                    $repoterId=$this->db->query("select *from news_reporter where email='".$this->session->userdata('email')."' ");
                    $getRepotrtId=$repoterId->row();
                   
                        echo $this->Crud_model->select_html('news_reporter', 'news_reporter', 'name', 'edit', 'demo-chosen-select required', $getRepotrtId->news_reporter_id);
